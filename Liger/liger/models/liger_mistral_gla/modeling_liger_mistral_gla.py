...
from . import LigerMistralGLAConfig
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.training or q.shape[-2] > 1:
            ...
            o_, recurrent_state = recurrent_gla(q=q, k=k, v=v, g=g, scale=scale, initial_state=recurrent_state, output_final_state=True, offsets=offsets)
